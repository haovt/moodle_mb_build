...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_13__core_course_providers_helper__ = __webpack_require__(22);
// (C) Copyright 2015 Moodle Pty Ltd.
//
// Licensed under the Apache License, Version 2.0 (the "License");
// you may not use this file except in compliance with the License.
...
var CoreCoursesDashboardPage = /** @class */ (function () {
    function CoreCoursesDashboardPage(navCtrl, coursesProvider, sitesProvider, siteHomeProvider, eventsProvider, dashboardProvider, domUtils, blockDelegate, courseHelper) {
        var _this = this;
         ...
         * @param id: page id
         */
        this.blockClickedGoToPage = function (id, url) {
            var pageParams = {
                courseId: 1,
                module: {
                    id: id,
            ...
            _this.navCtrl.push('AddonModPageIndexPage', pageParams, null);
        };
        this.loadSiteName();
    }
    /**
    ...
    CoreCoursesDashboardPage.prototype.loadDashboardContent = function () {
        ...
        return this.dashboardProvider
            ...
            if (available) {
                ...
                return _this.dashboardProvider
                    .getDashboardBlocks()
    ...
    CoreCoursesDashboardPage.prototype.blockClickedGoToCourse = function (courseId) {
        var courseObj = {
            id: courseId
        };
        var siteId = this.sitesProvider.getCurrentSiteId();
        this.courseHelper.openCourse(this.navCtrl, courseObj, null, siteId);
    };
    __decorate([
